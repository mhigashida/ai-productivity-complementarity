# code/fig_coef_prereg_modelB_eval.R
...
out_png <- file.path(out_dir, "fig_prereg_coef_modelB_eval_focal_vertical.png")
out_pdf <- file.path(out_dir, "fig_prereg_coef_modelB_eval_focal_vertical.pdf")
...
message("Saved clean coefficient plot.")